...
import {
  ...
  useFormControl
} from "./chunk-7B2CTHUI.js";
import "./chunk-J6POAYNW.js";
import {
  useTheme,
  useThemeProps
} from "./chunk-B4BX5A6M.js";
import {
  alpha,
  shouldForwardProp,
  useMediaQuery,
  useRtl
} from "./chunk-SNXFMK7V.js";
import "./chunk-EXOAFPCI.js";
import "./chunk-YQ5BCTVV.js";
import {
  createSvgIcon,
  init_utils
} from "./chunk-6G6I3ISW.js";
import "./chunk-OY7BIGRG.js";
import {
...
var PickersOutlinedInput = React33.forwardRef(function PickersOutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime15.jsx)(PickersInputBase, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime15.jsx)(Outline, {
      ...
      label: label != null && label !== "" && muiFormControl?.required ? (0, import_jsx_runtime15.jsxs)(React33.Fragment, {
        children: [label, " ", "*"]
      }) : label,
      ownerState
    })
...
var useMobilePicker = (_ref) => {
  ...
  const renderPicker = () => (0, import_jsx_runtime33.jsxs)(PickersProvider, {
    ...
    children: [(0, import_jsx_runtime33.jsx)(Field, _extends({}, fieldProps, {
      ...
      slots,
      slotProps,
      children: (0, import_jsx_runtime33.jsx)(Layout, _extends({}, layoutProps, slotProps?.layout, {
        slots,
        slotProps,
        children: renderCurrentView()
      }))
